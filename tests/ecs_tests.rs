...
fn setup_initial_entities(mut commands: Commands, mut tracker: ResMut<ScoreTracker>) {
    tracker.points = 100;
...
fn verify_resource_and_commands(tracker: Res<ScoreTracker>, query: Query<&Position, With<TagA>>) {
